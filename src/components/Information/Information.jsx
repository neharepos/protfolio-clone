...
const Information = () => {
  return (
    <div className='bg-blue-900 h-auto rounded-2xl sm:w-[90%] md:w-[80%]  mx-7 relative lg:absolute lg:bottom-5 lg:right-1 lg:w-[350px] xl:w-[400px] py-1  sm:p-2 md:p-10 mb-6 lg:mb-0'>
